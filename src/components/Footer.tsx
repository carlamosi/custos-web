      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 mb-12">
        <div>
          <Link to="/" className="flex items-center gap-2.5 mb-4">
            ...
            <img src={logoFull} alt="Custos" className="h-5" />
          </Link>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-foreground/70">
            ...
            <li><Link to="/producte" className="hover:text-secondary transition-colors">Producte</Link></li>
            <li><Link to="/impacte" className="hover:text-secondary transition-colors">Impacte</Link></li>
